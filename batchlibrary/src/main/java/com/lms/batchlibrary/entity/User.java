package com.lms.batchlibrary.entity;
...
public class User{
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", email=" + email + ", phone=" + phone + ", type=" + type
				+ ", dateOfMembership=" + dateOfMembership + ", blockUser=" + blockUser + ", totalFine=" + totalFine
				+ ", finePaid=" + finePaid + ", status=" + status + ", totalNumBooksCheckedOut="
				+ totalNumBooksCheckedOut + ", createdTS=" + createdTS + ", updatedTS=" + updatedTS + "]";
	}
